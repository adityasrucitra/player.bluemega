...
class ProfileModel extends Model
{
    ...
    protected $allowedFields = ['user_id', 'first_name', 'last_name', 'city', 'country', 'phone_number', 'timezone', 'country_id', 'city_id'];
    ...
    public function loadUser($data)
    {
        ...
        $bld = $this->db->table('profile p')
            ->select('p.user_id, c.name as country_name, cc.name as city_name')
            ->join('countries c', 'c.id=p.country_id')
            ->join('cities cc', 'cc.id=p.city_id')
