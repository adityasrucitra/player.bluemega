                  ...
                  <form action='create' method='post'>
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <select id="select2_countries" style="width: 100%" name='country_id'></select>
                      </div>

                      <div class="form-group">
                        <label for="input_state">State</label>
                        <select id="select2_states" style="width: 100%" name='state_id'></select>
                      </div>
                      <div class="form-group">
                        <label for="input_city">City</label>
                        <select id="select2_cities" style="width: 100%" name='city_id'></select>
                      </div>                      
                      <div class="form-group">
...
<script>
  ...
  $('#select2_states').select2({
    ajax: {
      url: '<?= base_url('accounts/getstates') ?>',
      dataType: 'json',
