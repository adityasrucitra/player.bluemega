...
<!-- DEBUG-VIEW START 2 APPPATH/Views/accounts/index.php -->
<!-- DEBUG-VIEW START 1 APPPATH/Views/layout.php -->
<!DOCTYPE html>
<html lang="en">

<head>
<script  id="debugbar_loader" data-time="1683596911.900753" src="http://localhost:8080/?debugbar"></script><script  id="debugbar_dynamic_script"></script><style  id="debugbar_dynamic_style"></style><script class="kint-rich-script">void 0===window.kintShared&&(window.kintShared=function(){"use strict";var e={dedupe:function(e,n){return[].forEach.call(document.querySelectorAll(e),function(e){e!==(n=n&&n.ownerDocument.contains(n)?n:e)&&e.parentNode.removeChild(e)}),n},runOnce:function(e){"complete"===document.readyState?e():window.addEventListener("load",e)}};return window.addEventListener("click",function(e){var n;e.target.classList.contains("kint-ide-link")&&((n=new XMLHttpRequest).open("GET",e.target.href),n.send(null),e.preventDefault())}),e}());
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="http://localhost:8080/profile" class="d-block">adityasrucitra</a>
                    </div>
                </div>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class='nav-item'>
                            ...
                            <ul class="nav nav-treeview" style="display: block;">
                                ...
                                <li class="nav-item">
                                    <a href="http://localhost:8080/accounts" class="nav-link">
                                    ...
                                    <ul class="nav nav-treeview">
                                                                                <li class="nav-item">
                                            <a href="http://localhost:8080/permissions" class="nav-link">
                                                <i class="far fa-dot-circle nav-icon"></i>
                                                <p>Permissions</p>
                                            </a>
                                        </li>
                                                                                                                        <li class="nav-item">
                                            <a href="http://localhost:8080/groups" class="nav-link">
                                                <i class="far fa-dot-circle nav-icon"></i>
                                                <p>Groups</p>
                                            </a>
                                        </li>
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <a href="http://localhost:8080/accounts/create" class='btn btn-success float-right'><i class="fas fa-plus"> New</i></a>              
            </div>
          </div>
        </div><!-- /.container-fluid -->
      </section>
...
<!-- DEBUG-VIEW ENDED 1 APPPATH/Views/layout.php -->

<!-- DEBUG-VIEW ENDED 2 APPPATH/Views/accounts/index.php -->